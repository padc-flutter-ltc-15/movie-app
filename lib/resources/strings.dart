...
const MAIN_SCREEN_BEST_POPULAR_MOVIES_AND_SERIES = "BEST POPULAR MOVIES AND SERIES";
const MAIN_SCREEN_SHOW_CASES = "SHOW CASES";
const MAIN_SCREEN_SEE_MORE_SHOW_CASES = "SEE MORE SHOW CASES";
const MAIN_SCREEN_BEST_ACTORS = "BEST ACTORS";
const MAIN_SCREEN_SEE_MORE_ACTORS = "SEE MORE ACTORS";
